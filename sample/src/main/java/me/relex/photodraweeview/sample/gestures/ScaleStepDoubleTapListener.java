...
import com.github.chrisbanes.photoview.DefaultOnDoubleTapListener;
...
public class ScaleStepDoubleTapListener extends DefaultOnDoubleTapListener {
    ...
    public ScaleStepDoubleTapListener(PhotoDraweeViewAttacher attacher) {
        super(attacher);
        mAttacher = attacher;
    }

    public ScaleStepDoubleTapListener(PhotoDraweeViewAttacher attacher, float scaleStep) {
        super(attacher);
        mAttacher = attacher;
